...
from .variables import GENDER, INCOME, MARRY_STATE, INDUSTRY, PROFESSION, THREE_STATE, BODY_SHAPE, STAR_SIGN, NATION


class UserInfo(CommonModel):
    user = models.OneToOneField(User)
    gender = models.CharField(GENDER, default="M", verbose_name="性别")
    ...
    birth_location = models.CharField(verbose_name="籍贯")
    educational_background = models.IntegerField(verbose_name="学历")
    industry = models.CharField(verbose_name="从事行业", choices=INDUSTRY, default="100")
    occupation = models.CharField(verbose_name="职业", choices=PROFESSION, default="10000")
    year_income = models.CharField(verbose_name="年收入", choices=INCOME)
    email = models.EmailField(blank=True, null=True, verbose_name="邮箱")
    marry_state = models.CharField(verbose_name="婚姻状况", choices=MARRY_STATE)
    has_children = models.CharField(verbose_name="是否有小孩", choices=THREE_STATE, default='0')
    has_house = models.CharField(verbose_name="是否有房", choices=THREE_STATE, default='0')
    has_car = models.CharField(verbose_name="是否有车", choices=THREE_STATE, default='0')
    weight = models.IntegerField(verbose_name='体重', default=0)
    shape = models.CharField(verbose_name='体型', choices=BODY_SHAPE, default='100')
    is_smoking = models.CharField(verbose_name='是否吸烟', choices=THREE_STATE, default='0')
    star_sigh = models.CharField(verbose_name='星座', choices=STAR_SIGN, default="100")
    nation = models.CharField(verbose_name='民族', choices=NATION, default="100")
...
class DesireCondition(models):
    ...
    industry = models.CharField(verbose_name="从事行业", choices=INDUSTRY, default="100")
    occupation = models.CharField(verbose_name="职业", choices=PROFESSION, default="10000")
    year_income = models.CharField(verbose_name="年收入", default='不限')
    marry_state = models.CharField(verbose_name="婚姻状况", choices=MARRY_STATE)
    has_children = models.CharField(verbose_name="是否有小孩", choices=THREE_STATE, default='0')
    has_house = models.CharField(verbose_name="是否有房", choices=THREE_STATE, default='0')
    has_car = models.CharField(verbose_name="是否有车", choices=THREE_STATE, default='0')
